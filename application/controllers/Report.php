...
class Report extends MY_Controller {
	...
	function create()
	{
		...
		$data ['ranks'] = get_keyed_pairs ( $this->menu->get_pairs ( "report_rank" ), array (
				"value",
				"label" 
		) );
		...
		$data ['statuses'] = get_keyed_pairs ( $this->menu->get_pairs ( "report_status" ), array (
				"value",
				"label" 
		) );
		$data ['categories'] = get_keyed_pairs ( $this->menu->get_pairs ( "report_category" ), array (
				"value",
				"label" 
		) );

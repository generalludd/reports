...
class Narrative extends MY_Controller
{
    ...
    function create ()
    {
        ...
        if ($submits_report_card == "yes") {
            ...
            $pass_fail = $this->grade_preferences->get_all($kStudent,
                    array(
    ...
    function view ()
    {
        ...
        $kTeach = $narrative->kTeach;
        $data['narrative'] = $narrative;
        $data['has_benchmarks'] = $this->benchmark_model->student_has_benchmarks($kStudent, $narrative->narrSubject, $narrative->stuGrade, $narrative->narrTerm,
                $narrative->narrYear);
        $data['benchmarks_available'] = $this->benchmark_model->benchmarks_available($narrative->narrSubject, $narrative->stuGrade, $narrative->narrTerm,
                $narrative->narrYear);
        if ($data['has_benchmarks']) {
            $data['legend'] = $this->legend->get_one(
                    array(
                            "kTeach" => $kTeach,
            ...
            $data["benchmarks"] = $this->benchmark_model->get_for_student($kStudent, $narrative->narrSubject, $narrative->stuGrade, $narrative->narrTerm,
                    $narrative->narrYear);
        }
        // determine if grades are manually entered or calculated from grade
        // report cards.
    ...
    /**
     * generate a list of narratives for a given student kStudent as provided in
     * the $_GET array
     */
    /*
    function student_list ()
    {
        ...
        $data["narrativeYears"] = $this->narrative_model->get_years($kStudent);

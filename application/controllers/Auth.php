...
class Auth extends CI_Controller {
  ...
  /**
   * login script both logs in and sets the required session data to keep the
   * user logged in. Also adds useful non-critical cookies to enhance the user
   * experience.
   ...
   * @param array $errors
   */
  function start_reset(array $errors = []): void {
    $data['errors'] = $errors;
   ...
   * @param array $errors ;
   */
  function show_reset(int $kTeach, string $resetHash, array $errors = []): void {
    $data['kTeach'] = $kTeach;

...
class admin extends MY_Controller {
	 ...
	 * (non-PHPdoc)
	 * 
	 * @see MY_Controller::index() go to the main admin control panel page
	 */
	function index()
	{
	...
	/**
	 * show the user access log.
	 * Most folks don't deliberately log out so the database mostly shows login times
	 */
	function show_log()
	{
		$options = array ();

...
value="<?=get_value($legend, "gradeStart"); ?>" size="3" maxlength="1">
<label for="term">Term:
...
<label for="subject">Subject:</label><?=form_dropdown('subject',$subjects,get_value($legend, "subject"),"id='subject'");?>
<p><label for="title">Title:</label><input type="text"
	id="title" name="title" value="<?=get_value($legend,"title");?>" /></p>

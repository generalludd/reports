...
<?php $buttons[] = array("selection"=>"benchmarks", "href"=>site_url("student_benchmark/select/?kStudent=$kStudent&subject=$subject&student_grade=$student_grade&quarter=$quarter&term=$term&year=$year&edit=1"), "class"=>"button edit", "text"=>"Edit Benchmarks");?>
...
$i = 1;
	...
	foreach ( $benchmarks as $benchmark ) :
		?>
<?php $row_class = $benchmark->grade == "X"?"not-assessed":"";?>
...
<!-- 		</tr> -->
	...
	<?php endif; ?>
	 <tr class="benchmark-row <?php echo $row_class;?>">
	<?php 	$mark="";?>
		<?php

...
<form style="max-width:370px" id="chart-search" name="chart-search" action="<?php  echo site_url("assignment/chart");?>" method="get">
...
<input type="text" id="gradeStart" name="gradeStart" value="<?php  echo $gradeStart; ?>" size="3"
	...
	<?php  echo form_dropdown("subject",$subjects,"","id='subject' required");?>
	</p>
...
-<input id="yearEnd" type="text" name="yearEnd" class='yearEnd' readonly
	...
	<p><label for="date_range">Date Range</label><input type="date" id="date_start" name="date_start" value="<?php  echo array_key_exists("date_start",$date_range)?$date_range["date_start"]:get_cookie("assignment_date_start");?>"/>-
	<input type="date" name="date_end" id="date_end" value="<?php  echo array_key_exists("date_end",$date_range)?$date_range["date_end"]:get_cookie("assignment_date_end");?>"/>
	</p>
	<p>
	<label for="student_sort_order">Sort Students by</label>
	<?php  echo form_dropdown("student_sort_order",array("stuFirst"=>"First Name","stuLast"=>"Last Name"),get_cookie("student_sort_order"),"id='student_sort_order'");?>
	</p>
	<p>

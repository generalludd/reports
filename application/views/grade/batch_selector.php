...
<form style="max-width:370px" id="batch-grade-selector" name="batch-grade-selector"
      action="<?php echo site_url("grade/batch_print"); ?>" method="post">
    ...
    <p><label for="year">Year: </label>
        ...
        -<input id="yearEnd" type="text" name="yearEnd" class='yearEnd' readonly
                maxlength="4" size="5" value="<?php $yearEnd = $year + 1;
        print $yearEnd; ?>"/></p>
    <p>

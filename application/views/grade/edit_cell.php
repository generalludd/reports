...
<input type="text" name="points" id="points_<?php  echo $grade->kAssignment;?>_<?php  echo $grade->kStudent;?>" autocomplete='off' size="2" class="assignment-grade" value="<?php  echo $grade->points;?>" /><br/>
&nbsp;
<?php $status_key = sprintf("'status_%s_%s'", $grade->kAssignment, $grade->kStudent);?>
<?php  echo form_dropdown("status",$status, $grade->status,"id=$status_key");?><br/>
&nbsp;
<?php $footnote_key = sprintf("'footnote_%s_%s'", $grade->kAssignment, $grade->kStudent);?>
<?php  echo form_dropdown("footnote",$footnotes, $grade->footnote,"id=$footnote_key");?>

...
<p><label for='gradeStart'>Grade Range: </label><input type="text" name="gradeStart" id="gradeStart" class="grade" value="<?php echo get_cookie($cookie_day. "gradeStart"); ?>" required/>&dash;
<input type="text" name="gradeEnd"  class="grade" id="gradeEnd" value="<?php echo get_cookie($cookie_day. "gradeEnd");?>" required/></p>
...
<p><label for="kTeach">Classroom Teacher or Advisor: </label><?php echo form_dropdown("kTeach",$teachers,get_cookie($cookie_day . "kTeach"),"id='kTeach'");?>
</p>
</div>
<p>

...
<div>
<label for="absent">Absent: </label><input name="absent" type="text" value="<?php echo get_value($attendance,"absent");?>" size="5"/>
&nbsp;
<label for="tardy">Tardy: </label><input name="tardy" type="text" value="<?php echo get_value($attendance,"tardy");?>" size="5"/>
</div>
<?php 

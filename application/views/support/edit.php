...
?>
<!-- support/edit.php -->
<form name="support-editor" id="support-editor" class="editor" action="<?php echo site_url("support/$action"); ?>"
      method="post">
    ...
    <p>
        <label for="year">Year for this
            Documentation:</label> <?php echo form_dropdown("year", $year_list, $year, "id='year' class='yearStart'"); ?>
        -
    ...
    <div class='<?php if (get_cookie("accordion") == "enable") {
        ...
        <div>
            ...
            <div class='notice'>i.e. Orton-Gillingham, Galtier, Homework Help, etc. Include start and end date if
                applicable.
            </div>
        ...
        <div>
            <div class="alert" id="attachment-content-warning" style="width: 45%">Make sure that any important points
                covered in attached files
                are also summarized above. This makes it easier for faculty and aides to quickly read a student's
                profile.
            </div>
            <p>
                        ...
                        <tr id='fr_<?php echo $file->kFile; ?>'>
                            <td>
                                <a href='<?php echo base_url("uploads/$file->file_name"); ?>'
                                   target='_blank'><?php echo $file->file_display_name; ?></a>
                            </td>

...
<?php $this->load->view("support/test_dates", array("dates" => $entry->testDates, "current_year" => $year)); ?>
...
<div class='file-attachments'>
    ...
    <table class="list files">
        ...
        <?php foreach ($files_array as $file): ?>
            <tr>
                <td class='file-name'><a href='<?php echo base_url("uploads/$file->file_name"); ?>'
                                         target='_blank'><?php echo $file->file_display_name; ?></a></td>

...
<form name="grade-preference-editor" id="grade-preference-editor" action="<?php  echo site_url("grade_preference/$action");?>" method="post">
...
<input type="checkbox" name="pass_fail" id="pass_fail" value="1" <?php  echo $pass_fail_check;?>/></p>
<p>

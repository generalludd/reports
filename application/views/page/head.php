...
<link type="text/css" rel="stylesheet" media="all" href="<?=base_url("css/navigation.css?") . date("U");?>" />
...
<script>tinymce.init({ selector:'textarea.tinymce',
	...
	toolbar: 'bold,italic,formatselect,bullist,numlist,|,cut,copy,paste,pastetext,pasteword,removeformat,code,|,undo,redo,searchreplace',

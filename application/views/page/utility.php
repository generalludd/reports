...
$user_buttons[] = array("selection"=>"teacher", "class"=>"link", "text"=>"Account Info","href"=>site_url("teacher/view/$userID"));
if($this->session->userdata("userID")== 1000){
	$user_buttons[] = array("selection"=>"admin","class"=>"link","text"=>"Site Admin","href"=>site_url("admin"));
}else{
